 ...
 */
final class Version20200516183423 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, message VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_4C62E638A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, duration_id INT DEFAULT NULL, user_id INT DEFAULT NULL, type_service_id INT DEFAULT NULL, category_id INT DEFAULT NULL, sub_cat_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL, status VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_E19D9AD237B987D8 (duration_id), INDEX IDX_E19D9AD2A76ED395 (user_id), INDEX IDX_E19D9AD2F05F7FC3 (type_service_id), INDEX IDX_E19D9AD212469DE2 (category_id), INDEX IDX_E19D9AD254FCE60F (sub_cat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, rankUser_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, postal_code INT NOT NULL, image VARCHAR(255) DEFAULT NULL, time_gauge INT NOT NULL, total_time_service_given INT NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D6497616678F (rankUser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rankUser (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, count INT NOT NULL, logo VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mailbox (id INT AUTO_INCREMENT NOT NULL, user_from_id INT DEFAULT NULL, user_for_id INT DEFAULT NULL, message_title VARCHAR(255) DEFAULT NULL, message_body LONGTEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_A69FE20B20C3C701 (user_from_id), INDEX IDX_A69FE20B4969C270 (user_for_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE service ADD CONSTRAINT FK_E19D9AD254FCE60F FOREIGN KEY (sub_cat_id) REFERENCES sub_category (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE service DROP FOREIGN KEY FK_E19D9AD254FCE60F');
